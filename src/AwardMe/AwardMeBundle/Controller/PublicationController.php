...
class PublicationController extends Controller
{
    ...
    public function removeImageAction($id){
        ...
        if(!$publicationService->removePublicationImage($id, $this->getUser())){
            throw $this->createNotFoundException('Cette publication n\'existe pas ou vous ne pouvez pas la supprimé');
        }
    ...
    public function updatePublicationImageAction(Request $request, $id){

        $publication = $this->getDoctrine()->getManager()->getRepository('AwardMeBundle:PublicationImage')->findOneById($id);
        ...
        $form = $this->createForm(new PublicationImageType(), $publication);
        ...
        return $this->render('AwardMeBundle:Formulaires:PublicationImageUpdate.html.twig', array('form' => $form->createView(), 'publication' => $id));
    }
